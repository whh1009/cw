(function(e) {
		...
		validate : function() {
			...
			this.el.find("[data-validate]").each(
					function(r, i) {
						...
						if (!o.status) {
							t = true;
							i.parents("div.form-group").toggleClass(
									"has-error", true);
							if (e("#btn-" + i.attr("id")).length === 1) {
								i = e("#btn-" + i.attr("id"))
							}
	...
	Wizard.prototype = {
		...
		_create : function(t) {
			...
			this.wizardCardContainer = this.modal
					.find(".wizard-card-container");
			this.wizardCardContainer.append(this.markup.find(".wizard-card"))
			...
			this.progressContainer = this.modal
					.find(".wizard-progress-container");
			...
			this.wizardSteps.on("click",
					"li.already-visited a.wizard-nav-link", this, function(t) {
		...
		autoDimensions : function() {
			...
			if (this.dimensions.navigation < this.dimensions.contentHeight) {
				...
				this.navContainer.height(this.dimensions.contentHeight - 30
			...
			this.dimensions.modal = this.dimensions.header
					+ this.dimensions.navigation;
			...
			this.dimensions.cardContainer = this.dimensions.body
					- this.dimensions.footer;
		...
		hideSubmitCards : function() {
			var t = this;
			e.each([ "success", "error", "failure", "loading" ],
					function(e, n) {
						t.hideSubmitCard(n)
					})
		},
		...
		serializeArray : function() {
			...
			this.form.find('input[disabled][data-serialize="1"]').each(
					function() {
						formObj = {
